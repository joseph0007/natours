...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"alertMessage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addAlert = exports.removeAlert = void 0;
...
var addAlert = function addAlert(type, message) {
  removeAlert();
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log(email, password); //using axios to send a http request(POST) to our url
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _alertMessage.addAlert)('success', response.data.message);
              changeURL();
            }
          ...
          case 9:
            ...
            (0, _alertMessage.addAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alertMessage.addAlert)('error', _context2.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alertMessage":"alertMessage.js"}],"mapBox.js":[function(require,module,exports) {
"use strict";
...
var setMap = function setMap() {
  if (document.getElementById('map')) {
    var locations = JSON.parse(document.getElementById('map').dataset.locations); //mapboxgl object is available to us from the script that we loaded in the head!!

    mapboxgl.accessToken = 'pk.eyJ1Ijoiam9zZXBoam95IiwiYSI6ImNrZzIxcTRubjBkZTYycnBhOXA5c3N5bTIifQ.2CSV6snrC1vSDPT3XksxAw';
    ...
    locations.forEach(function (loc) {
      ...
      element.className = 'marker'; //add a popup

      new mapboxgl.Popup({
        offset: 30
      }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "  </p>")).addTo(map); //add the location coordinates to the bounds object
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("".concat(window.origin, "/api/v1/bookings/checkout-session/").concat(tourId));

          case 3:
            session = _context.sent;
            // create a Stripe object instance
            stripe = Stripe('pk_test_51HdVPkGONLSY38qKTtDz91jbnvO12EAQ8yBI0BrZMD3xAbsvL2ChmTHT8k0hRrudfVBRJpDa8Fx6Q0qlTSB9fjo5003woFNwsG'); // redirect the page to checkout form
          ...
          case 10:
            ...
            (0, _alertMessage.addAlert)(error.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alertMessage":"alertMessage.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alertMessage":"alertMessage.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var formEle = document.querySelector('.form--login');
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); //get user details
              ...
              form.append('photo', document.getElementById('photo').files[0]); //rendering the button

              btn = document.querySelector('.btn--details');
              btn.textContent = 'updating...'; //update data

              _context.next = 9;
              return (0, _updateSettings.updateSettings)(form, 'user-details');
...
if (updatePass) {
  updatePass.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var newPassword, password, confirmPassword, btn;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              confirmPassword = document.getElementById('password-confirm').value; //rendering the button

              btn = document.querySelector('.btn--password');
              btn.textContent = 'updating...'; //update data
            ...
            case 8:
              //re-render the button
              btn.textContent = 'save password'; //clear the fields
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              bookBtn.textContent = 'Processing...'; //call the bookTour function to redirect to checkout page
